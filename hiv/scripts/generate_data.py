...
def evaluate_summaries(graph0: nx.Graph, graph1: nx.Graph) -> dict[str, float]:
    ...
    # Evaluate number of nodes and nodes with casual relationships by relationship status.
    ...
    for _ in tqdm(range(args.num_samples)):
        ...
        for step in range(args.num_lags):
            ...
            if step == args.num_lags - 1:
                continue
            stockholm.simulate(n=args.n, num_steps=1, step=burnin + step, graph=graph1, **params)
